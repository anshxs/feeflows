...
export default function LoginPage() {
  ...
  useEffect(() => {
    async function fetchSchools() {
      let { data, error } = await supabase.from("schools").select("*");
  ...
  async function handleSchoolSelect(schoolId: string) {
    ...
    let { data } = await supabase.from("schools").select("branch").eq("id", schoolId);
  ...
  return (<>
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#f9fafa]">
      ...
      <div className="absolute top-5 left-5">
        <img src="/lo.png" alt="Logo" className="h-12 w-auto" />
      </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
      ...
      <div>
        ...
        <ul className="space-y-2 text-sm">
          <li><a href="/" className="text-blue-500 hover:text-blue-400 transition">Pay Fees</a></li>
          <li><a href="mailto:anshsxa@gmail.com" className="text-blue-500 hover:text-blue-400 transition">Contact Us</a></li>
          <li><a href="/register" className="text-blue-500 hover:text-blue-400 transition">Register school</a></li>
          <li><a href="/schools" className="text-blue-500 hover:text-blue-400 transition">Registered Schools</a></li>
          <li><a href="/school" className="text-blue-500 hover:text-blue-400 transition">School Login</a></li>
